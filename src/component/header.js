...
function Header() {
    ...
    function submit(e) {
        ...
        axios.post('http://localhost/instello/file.php',
            data)
            .then(function (response) {
                // handle success
    ...
    function submit_video(e) {
        ...
        // alert()
        const data = new FormData()
        data.append('video', video.current.files[0])
        data.append('uid', a)

        axios.post('http://localhost/instello/video.php',
            data)
            .then(function (response) {
                // handle success
                console.log(response);
                ...
                <div className="header_inner">
                    <div className="left-side">
                        ...
                        <div id="logo" className=" uk-hidden@s">
                            <a href="home.html">
                                <img src={require('../img/logo-mobile.png')} alt />
                                <img src={require('../img/logo-mobile-light.png')} className="logo_inverse" />
                            </a>
                        </div>
               ...
               mr-1 opacity-90 text-xl uilus-circle" /> Upload
                        ...
                        <div uk-dropdown="pos: top-right;mode:click ; animation: uk-animation-slide-bottom-small" className="header_dropdown">
                            ...
                            <div className="flex justify-center flex-center text-center dark:text-gray-300">
                                <div className="flex flex-col choose-upload text-center">
                                    ...
                                    <form method='post' onSubmit={submit}>
                                        <div uk-form-custom >
                                            ...
                                            {/* <a href="#"   className="" > Choose file</a> */}
                                            <button className='button soft-warning small ' type='submit'>upload</button>
                                        </div>
                                    </form>
                                ...
                                <div className="uk-flex uk-flex-column choose-upload" hidden>
                                    ...
                                    <form className="uk-grid-small" uk-grid onSubmit={submit_video} method='post'>
                                        <div className="uk-width-expand">
                                            ...
                                            <input type="file" className='mb-3 mt-3' ref={video} name='video' />
                                        </div>
                        ...
                        <div uk-drop="mode: click;offset: 4" className="header_dropdown">
                            ...
                            <ul className="dropdown_scrollbar" data-simplebar>
                                <li>
                                    <a href="#">
                                        <div className="drop_avatar">
                                            <img src={require('../img/avatars/avatar-1.jpg')} alt />
                                        </div>
                                ...
                                <li>
                                    <a href="#">
                                        <div className="drop_avatar">
                                            <img src={require('../img/avatars/avatar-2.jpg')} alt />
                                        </div>
                                        <div className="drop_content">
                                            <p>
                                ...
                                <li>
                                    <a href="#">
                                        <div className="drop_avatar"> <img src={require('../img/avatars/avatar-3.jpg')} alt />
                                        </div>
                                        <div className="drop_content">
                                            <p>
                                ...
                                <li>
                                    <a href="#">
                                        <div className="drop_avatar"> <img src={require('../img/avatars/avatar-1.jpg')} alt />
                                        </div>
                                        <div className="drop_content">
                                            <p>
                                                <strong>Stella Johnson</strong> Nonummy nibh euismod
                        ...
                        <div uk-drop="mode: click;offset: 4" className="header_dropdown">
                            ...
                            <ul className="dropdown_scrollbar" data-simplebar>
                                ...
                                <li>
                                    <a href="#">
                                        <div className="drop_avatar"> <img src={require('../img/avatars/avatar-2.jpg')} alt />
                                        </div>
                                        <div className="drop_content">
                                    ...
                                    if (i.id == a) {
                                        return (
                                            <>
                                                ...
                                                <img src={`http://localhost/instello/image/${i.image}`} className="header-avatar" alt />
                                            </>
                                        )
                                    }
                                })
